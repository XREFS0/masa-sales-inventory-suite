...
from utils import get_products, select_by_id_or_name, safe_input, update_products
...
def register_product_arrival():
    ...
    print("OKAY. You've registered %s items of %s product" % (arrival_quantity, chooosen_product["name"]))
